...
최신 alpha.19 변경 파일·검증 결과는
[`docs/v0.4.0-alpha.19-report.md`](docs/v0.4.0-alpha.19-report.md)에 정리되어 있습니다.


> v0.4.0-alpha.19 policy: the Ranked allowlist checks currently enabled + loaded mods only. Installed-but-disabled mods do not block Ranked; required mods such as CBF must still be active.
