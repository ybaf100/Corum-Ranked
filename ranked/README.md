...
[`docs/v0.4.0-alpha.15-report.md`](docs/v0.4.0-alpha.15-report.md)에 정리되어 있습니다.


> v0.4.0-alpha.15 policy: the Ranked allowlist checks currently enabled + loaded mods only. Installed-but-disabled mods do not block Ranked; required mods such as CBF must still be active.


## alpha.15 scoring / Death Match hardening
